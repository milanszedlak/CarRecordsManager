...
This is my assignment for university where I had to make a records appication where it reads/writes to an text file, It uses java.swing for the main GUI of the application and uses google.gson to create JSON objects directly from my custom classes
...
Select all the jars that are inluded in the project

3. click okay and apply and close
...
4. run the tests package with the configuration
